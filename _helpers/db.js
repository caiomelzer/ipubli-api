...
async function initialize() {
   ...
   // await connection.query(`DROP DATABASE \`${database}\`;`);
    ...
    db.City = require('../components/domains/city.model')(sequelize);
    db.Country = require('../components/domains/country.model')(sequelize);
    db.State = require('../components/domains/state.model')(sequelize);
    ...
    db.FavoriteView = require('../components/favorites/favorite_view.model')(sequelize);
   ...
   /*
    ...
    await connection.query(`INSERT INTO States (id, state,countryId, createdAt, updatedAt) VALUES (DEFAULT, 'SP',1, NOW(), NOW());`);
    await connection.query(`INSERT INTO States (id, state,countryId, createdAt, updatedAt) VALUES (DEFAULT, 'RJ',1, NOW(), NOW());`);
    await connection.query(`INSERT INTO Networks (id, userId, status, network, avatar, url, followers, posts, createdAt, updatedAt, username, networkIdent) VALUES (NULL, '5', 'ACTIVE', 'INSTAGRAM', '/assets/images/avatar.png', 'https://www.instagram.com/', '0', '0', NOW(), NOW(), 'ladylawoficial','');`);
    await connection.query(`INSERT INTO Networks (id, userId, status, network, avatar, url, followers, posts, createdAt, updatedAt, username, networkIdent) VALUES (NULL, '4', 'ACTIVE', 'INSTAGRAM', '/assets/images/avatar.png', 'https://www.instagram.com/', '0', '0', NOW(), NOW(), 'caiomelzer','');`);
    await connection.query(`INSERT INTO Networks (id, userId, status, network, avatar, url, followers, posts, createdAt, updatedAt, username, networkIdent) VALUES (NULL, '3', 'ACTIVE', 'INSTAGRAM', '/assets/images/avatar.png', 'https://www.instagram.com/', '0', '0', NOW(), NOW(), '','');`);
    await connection.query(`INSERT INTO Segments (id, segment, userId, createdAt, updatedAt) VALUES (NULL, 'beleza', '3', NOW(), NOW());`);
    await connection.query(`INSERT INTO Segments (id, segment, userId, createdAt, updatedAt) VALUES (NULL, 'beleza', '4', NOW(), NOW());`);
    await connection.query(`INSERT INTO Segments (id, segment, userId, createdAt, updatedAt) VALUES (NULL, 'futebol', '4', NOW(), NOW());`);
    ...
    await connection.query(`INSERT INTO Favorites (id, userId, influencerId, createdAt, updatedAt) VALUES (NULL, '1', '4', NOW(), NOW());`);
